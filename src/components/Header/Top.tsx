  ...
  return (
    <Box sx={{ flexGrow: 1 }}>
      <Grid height={{ sm: 114, xs: 68 }} container spacing={2}>
        <Grid height={{ sm: 114, xs: 68 }} display={"flex"}
          justifyContent={"flex-start"} item xs={6}>
          <Stack width={{ xs: 130 }} display={'flex'} p={{xs:1, md:3 }} justifyContent={'center'}>
        ...
        <Grid
          ...
          xs={6}
        >
          <Stack display={"flex"} justifyContent={"center"} p={{xs:1, md:3}}>
